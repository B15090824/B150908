...
#define sizeOwn sizeof(Owner)          /*一个车主记录所需要的内存空间大小*/
...
void calcuTimetable(double m[1][3],Owner Own[],int n);                /*求车主的最长、最短、平均停车时间*/
...
int deleteOwn(Owner Own[],int n,Owner s);            /*从数组中删除一个指定车牌号的元素*/
#endif